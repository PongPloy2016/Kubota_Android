...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    //private int mTabViewBadgeNumber;
   ...
   /* public void setCustomTabView(int layoutResId, int textViewId, int badgeResId, int badgeNum) {
        mTabViewLayoutId = layoutResId;
        mTabViewTextViewId = textViewId;

        mTabViewBadgeViewId = badgeResId;
        //mTabViewBadgeNumber = badgeNum;
    }*/
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTabViewLayoutId != 0) {
                ...
                tabBadgeView = (TextView) tabView.findViewById(mTabViewBadgeViewId);
            }
           ...
           /* if(tabBadgeView != null){
                if(mTabViewBadgeNumber > 0 ){
                    tabBadgeView.setText(String.valueOf(mTabViewBadgeNumber));
                }else{
                    tabBadgeView.setVisibility(GONE);
                }
    ...
    private class TabClickListener_bak implements OnClickListener {
        @Override
        public void onClick(View v) {
            for (int i = 0; i < mTabStrip.getChildCount(); i++) {
